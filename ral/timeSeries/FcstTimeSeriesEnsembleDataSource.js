 ...
 */
ral.timeSeries.FcstTimeSeriesEnsembleDataSource = function ( options ) {
 ...
 */
ral.timeSeries.FcstTimeSeriesEnsembleDataSource.prototype = Object.create( ral.timeSeries.jqplot.JQPlotDataSource.prototype );
 ...
 */
ral.timeSeries.FcstTimeSeriesEnsembleDataSource.prototype.getDataUrl = function( start, end ) {
  return this.dataUrl;
};
 ...
 */
ral.timeSeries.FcstTimeSeriesEnsembleDataSource.prototype.parseData = function( rawData ) {
    ...
    for( var seriesIndex = 1; seriesIndex < data.length; seriesIndex++ ) {
        ...
        ensembleSeriesOptions.label = (seriesIndex) + "0% Probability"
 ...
 */
ral.timeSeries.FcstTimeSeriesEnsembleDataSource.prototype.getSeriesOptions = function() {
